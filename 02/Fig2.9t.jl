...
# ╔═╡ d40ff1b3-de8a-4555-b881-bbfaf3b32da5
map_estimate = optimize( globethrowing(w, l), MAP())

# ╔═╡ 7103e901-56a5-4bad-96d6-dcf60fcbfc50
mle_estimate = optimize( globethrowing(w, l), MLE())

# ╔═╡ e7c54f91-aff7-479b-a3a9-8978bc90d141
typeof(mle_estimate)

# ╔═╡ 3a445062-0c94-44c3-b428-ceb14b31155c
vcov(map_estimate)

# ╔═╡ 48366698-aa34-4720-be1c-4b79166ac714
√vcov(map_estimate)[:p, :p]
...
begin
	...
	f[3] = plot( x, pdf.(Beta( w+1 , n-w+1 ) , x ), xlims=(-0.5, 1.0),
	  lab="Conjugate solution", leg=:topleft)
	plot!( f[3], x,
		pdf.(Normal( map_estimate.values[:p],
			√collect(reshape(vcov(map_estimate), 1, 1))[1]) , x ), 
...
git-tree-sha1 = "201e4e002349705e95fd8773dd54d6681eb9978a"
...
git-tree-sha1 = "480c3f92f892e18e5966b3c06d9c04bf42c2c484"
uuid = "2d09df54-9d0f-5258-8220-54c2a3d4fbee"
version = "4.0.8"

[[StatisticalRethinkingPlots]]
deps = ["DataFrames", "DocStringExtensions", "GR", "LaTeXStrings", "Parameters", "Plots", "Requires", "StatisticalRethinking", "StatsBase", "StatsPlots"]
git-tree-sha1 = "b0c0d2ff2b644d2d91054653036f917dd8118843"
